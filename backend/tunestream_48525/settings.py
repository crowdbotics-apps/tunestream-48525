"""
Django settings for tunestream_48525 project.
...
ROOT_URLCONF = 'tunestream_48525.urls'
...
WSGI_APPLICATION = 'tunestream_48525.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TuneStream Support <support@tunestream-48525.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tunestream_48525 API",
    "DESCRIPTION": "API documentation for tunestream_48525 App",
    "VERSION": "v1",
}
